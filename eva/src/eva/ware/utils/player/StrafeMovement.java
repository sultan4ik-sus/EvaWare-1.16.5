...
public class StrafeMovement implements IMinecraft {
    ...
    public double calculateSpeed(final EventMoving move, boolean damageBoost, boolean hasTime, boolean autoJump, float damageSpeed) {
    ...
    private float getFrictionFactor(final ClientPlayerEntity contextPlayer, final EventMoving move) {
