...
public class SuccessNotify extends Notify {
    ...
    public void render(MatrixStack matrixStack, int multiplierY) {
        ...
        int i = ColorUtility.rgba(109, 255, 86, (int) (60 * alphaValue));
        int o = ColorUtility.rgba(72, 255, 44, (int) (alphaValue));
        ...
        ClientFonts.icons_wex[iconSizeF].drawString(matrixStack, "K", posX - (iconSize - 2.5) + animPos, posY - height / 2 + ClientFonts.icons_wex[iconSizeF].getFontHeight() - margin / 2 + 0.5f, ColorUtility.reAlphaInt(-1, (int) (255 * alphaValue)));
        ClientFonts.msMedium[fontSize].drawString(matrixStack, getContent(), posX + margin + animPos, posY + margin / 2F + 3f, ColorUtility.reAlphaInt(-1, (int) (255 * alphaAnimation.getValue())));
    }
