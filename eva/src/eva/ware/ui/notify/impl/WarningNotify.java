...
public class WarningNotify extends Notify {
    ...
    public void render(MatrixStack matrixStack, int multiplierY) {
        ...
        int i = ColorUtility.rgba(236, 250, 35, (int) (60 * alphaValue));
        int o = ColorUtility.rgba(245, 255, 94, (int) (20 * alphaValue));
        ...
        ClientFonts.icons_wex[iconSizeF].drawString(matrixStack, "L", posX - (iconSize - 3.5) + animPos, posY - height / 2 + ClientFonts.icons_wex[iconSizeF].getFontHeight() - margin / 2 + 0.5, ColorUtility.reAlphaInt(-1, (int) (255 * alphaValue)));
        ClientFonts.msMedium[fontSize].drawString(matrixStack, getContent(), posX + margin + animPos, posY + margin / 2F + 2.5f, ColorUtility.reAlphaInt(-1, (int) (255 * alphaAnimation.getValue())));
    }
