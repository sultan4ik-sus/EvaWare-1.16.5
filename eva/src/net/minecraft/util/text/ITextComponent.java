...
import eva.ware.modules.impl.misc.NameProtect;
...
default <T> Optional<T> func_230534_b_(IStyledTextAcceptor<T> acceptor, Style style)
    {
        return acceptor.accept(style, NameProtect.getReplaced(this.getUnformattedComponentText()));
    }

default <T> Optional<T> func_230533_b_(ITextAcceptor<T> acceptor)
    {
        return acceptor.accept(NameProtect.getReplaced(this.getUnformattedComponentText()));
    }
