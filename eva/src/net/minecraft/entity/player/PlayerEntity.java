...
import eva.ware.modules.impl.misc.AutoActions;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public void tick() {
        ...
        Evaware.getInst().getEventBus().post(livingUpdate);
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoActions autoActions = Evaware.getInst().getModuleManager().getAutoActions();
        return !p_234569_1_.getRequiresTool() || (autoActions.isEnabled() && autoActions.actions.is("AutoTool").getValue() && autoActions.silent.getValue() && autoActions.itemIndex != -1
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            boolean keepSprintState = autoSprint.isEnabled() && autoSprint.saveSprint.getValue()
    ...
    public boolean isPushedByWater() {
        ...
        if (antiPush.isEnabled() && antiPush.modes.is("Вода").getValue() && this instanceof ClientPlayerEntity) {
            return false;
        }
        return !this.abilities.isFlying;
    }
