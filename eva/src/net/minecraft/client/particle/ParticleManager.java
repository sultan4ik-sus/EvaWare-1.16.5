...
//        if (BetterMinecraft.isFpsMode() || Evaware.getInst().getModuleManager().getNoRender().isEnabled() && Evaware.getInst().getModuleManager().getNoRender().element.is("Партиклы").getValue()) return;
        boolean fps = BetterMinecraft.isFpsMode() || Evaware.getInst().getModuleManager().getNoRender().isEnabled() && Evaware.getInst().getModuleManager().getNoRender().element.is("Партиклы").getValue();
