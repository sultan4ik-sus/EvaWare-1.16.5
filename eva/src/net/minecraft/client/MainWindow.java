...
public final class MainWindow implements AutoCloseable {
    ...
    public void setGuiScale(double scaleFactor) {
        this.guiScaleFactor = 2;
        int i = (int) ((double) this.framebufferWidth / 2);
        this.scaledWidth = (double) this.framebufferWidth / 2 > (double) i ? i + 1 : i;
        int j = (int) ((double) this.framebufferHeight / 2);
        this.scaledHeight = (double) this.framebufferHeight / 2 > (double) j ? j + 1 : j;
    }
    ...
    public int scaledWidth() {
        ...
        scale = (double) this.framebufferWidth / 2 > (double) i ? i + 1 : i;
    ...
    public int scaledHeight() {
        int scale = 0;
        int i = (int) ((double) this.framebufferHeight / 2);

        scale = (double) this.framebufferHeight / 2 > (double) i ? i + 1 : i;
