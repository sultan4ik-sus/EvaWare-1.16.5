...
public abstract class AbstractSlider extends Widget
{
    ...
    protected void renderBg(MatrixStack matrixStack, Minecraft minecraft, int mouseX, int mouseY)
    {
        if (SelfDestruct.unhooked) {
            ...
            RenderUtility.drawShadow(this.x + 3, this.y + 3, (float) (this.sliderValue * (double) (this.width - 6)), 20 - 6, 2, ColorUtility.setAlpha(Theme.rectColor, 80));
            RenderUtility.drawRoundedRect(this.x + 3, this.y + 3, (float) (this.sliderValue * (double) (this.width - 6)), 20 - 6, 2, ColorUtility.setAlpha(Theme.rectColor, 80));
        }
    }
