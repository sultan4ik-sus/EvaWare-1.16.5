        ...
        if (!this.func_238496_i_())
        {
            ...
            if (k > 0)
            {
                ...
                for (int j1 = 0; j1 + this.scrollPos < this.drawnChatLines.size() && j1 < j; ++j1) {
                    ...
                    BetterMinecraft better = Evaware.getInst().getModuleManager().getBetterMinecraft();
                    boolean isBetter = better.isEnabled() && better.betterChat.getValue();
                    if (isBetter && !SelfDestruct.unhooked) {
                    ...
                    if (SelfDestruct.unhooked) {
                        chatline.getSlideAnimation().setValue(1.0);
                    } else if (Evaware.getInst().getModuleManager().getBetterMinecraft().smoothChat.getValue()) {
