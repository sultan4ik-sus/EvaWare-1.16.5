...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Evaware.getInst().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Evaware.getInst().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Evaware.getInst().getViaMCP().viaScreen.tick();
