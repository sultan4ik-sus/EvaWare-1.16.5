...
default IVertexBuilder color(float red, float green, float blue, float alpha)
    ...
    default IVertexBuilder color(int rgb)
    {
        float[] color = RenderUtils.IntColor.rgb(rgb);
        return this.color(color[0],color[1],color[2],color[3]);
    }
...
default IVertexBuilder pos(Matrix4f matrixIn, float x, float y, float z)
    ...
    {
        double f = matrixIn.getTransformX(x, y, z, 1.0F);
        double f1 = matrixIn.getTransformY(x, y, z, 1.0F);
        double f2 = matrixIn.getTransformZ(x, y, z, 1.0F);
        return this.pos((double)f, (double)f1, (double)f2);
    }
