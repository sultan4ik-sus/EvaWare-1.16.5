...
public class MultiplayerScreen extends Screen
{
    ...
    private void func_214285_a(boolean p_214285_1_)
    {
        ...
        {
            String serverIP = ((ServerSelectionList.NormalEntry)serverselectionlist$entry).getServerData().serverIP;

            if (serverIP.equalsIgnoreCase("code.metahvh.space") || serverIP.equalsIgnoreCase("new.bingohvh.ru")) {
