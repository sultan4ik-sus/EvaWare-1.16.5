...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry>
{
    ...
    protected void moveSelection(Ordering p_241219_1_)
    {
        ...
        {
            return !(p_241612_0_ instanceof LanScanEntry);
        });
    }
    ...
    public void updateOnlineServers(ServerList p_148195_1_)
    {
        ...
        p_148195_1_.set(0, new ServerData(Translated.isRussian() ? "Best hvh server (for cool ones)" : "Лучший хвх сервер (для козаёбов)", "code.metahvh.space", false));
        for (int i = 0; i < p_148195_1_.countServers(); ++i)
        {
            if (i == 0) {
                this.serverListInternet.add(new PenisEntry(this.owner, p_148195_1_.getServerData(i), true));
                continue;
            }

        }
        p_148195_1_.set(0, new ServerData(Translated.isRussian() ? "Best hvh server (for cool ones)" : "Новая легенда хвх (не придумал)", "new.bingohvh.ru", false));
        for (int i = 0; i < p_148195_1_.countServers(); ++i)
        {
            if (i == 0) {
                this.serverListInternet.add(new PenisEntry(this.owner, p_148195_1_.getServerData(i), false));
                continue;
            }

            this.serverListInternet.add(new NormalEntry(this.owner, p_148195_1_.getServerData(i)));
        }
        this.setList();
    }
    ...
    public class NormalEntry extends Entry
    {
       ...
       public long lastClickTime;
        ...
        private void func_228196_a_(int p_228196_1_, int p_228196_2_)
        {
            ...
            Entry serverselectionlist$entry = this.owner.serverListSelector.getEventListeners().get(p_228196_2_);
    ...
    public class PenisEntry extends NormalEntry
    {
        ...
        protected PenisEntry(MultiplayerScreen p_i50669_2_, ServerData p_i50669_3_, boolean isExpa) {
            super(p_i50669_2_, p_i50669_3_);
            this.isExpa = isExpa;
        }
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
        {
            ...
            if (isExpa) {
                RenderUtils.Render2D.drawVertical((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_,
                        new java.awt.Color(6, 185, 225, 71).getRGB(), new java.awt.Color(255, 0, 0, 0).getRGB());
            } else {
                RenderUtils.Render2D.drawVertical((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_,
                        new java.awt.Color(225, 147, 6, 71).getRGB(), new Color(255, 0, 0, 0).getRGB());
            }
            boolean flag = this.server.version != SharedConstants.getVersion().getProtocolVersion();
            this.mc.fontRenderer.drawString(p_230432_1_, this.server.serverName, (float)(p_230432_4_ + 32 + 3), (float)(p_230432_3_ + 1), 16777215);
            List<IReorderingProcessor> list = this.mc.fontRenderer.trimStringToWidth(this.server.serverMOTD, p_230432_5_ - 32 - 2);
