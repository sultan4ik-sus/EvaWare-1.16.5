...
import newcode.fun.control.cmd.impl.GPSCmd;
...
import newcode.fun.module.impl.render.Crosshair;
...
public class IngameGui extends AbstractGui {
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
        ...
        IWrapper.executeQueue(true);
        EventManager.call(new EventRender(partialTicks, matrixStack, mainWindow, EventRender.Type.RENDER2D, null));
        if (Manager.FUNCTION_MANAGER.hud2.state && Manager.FUNCTION_MANAGER.hud2.elements.get(4)) {
            Manager.NOTIFICATION_MANAGER.draw(matrixStack);
        }
        GPSCmd.drawArrow(matrixStack);
        BloomHelper.draw(15, 2F, false, 1F);
    ...
    private void func_238447_a_(MatrixStack p_238447_1_, ScoreObjective p_238447_2_) {
        ...
        int j2 = (int) (this.scaledHeight / 2 + (int) (collection.size() * 9 / 3));
    ...
    public void func_238452_a_(@Nullable ITextComponent p_238452_1_, @Nullable ITextComponent p_238452_2_, int p_238452_3_, int p_238452_4_, int p_238452_5_) {
        EventOverlaysRender overlaysRender = new EventOverlaysRender(EventOverlaysRender.OverlayType.TITLES);
        EventManager.call(overlaysRender);
