...
public class PlayerTabOverlayGui extends AbstractGui {
    ...
    public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
        ...
        for (int i5 = 0; i5 < i4; ++i5) {
            ...
            int l2 = k1 + j2 * 9;
                boolean isPlayer = this.getDisplayName(list.get(i5)).getString().contains(mc.player.getNameClear());
                boolean isPlayerVanish = this.getDisplayName(list.get(i5)).getString().contains(mc.player.getNameClear());
                if (isPlayer) {
                    fill(p_238523_1_, k2, l2, k2 + i1, l2 + 8, ColorUtils.getColor(0, 128, 200, 108));
                } else if (isPlayerVanish) {
                    fill(p_238523_1_, k2, l2, k2 + i1, l2 + 8, ColorUtils.getColor(128, 20, 50, 108));
                } else {
    ...
    protected void func_238522_a_(MatrixStack p_238522_1_, int p_238522_2_, int p_238522_3_, int p_238522_4_, NetworkPlayerInfo p_238522_5_) {
        ...
        String ping = String.valueOf(MathHelper.clamp(p_238522_5_.getResponseTime(), 0, 999));

        Fonts.newcode[11].drawStringWithOutline(p_238522_1_, ping, (p_238522_3_ + p_238522_2_ - 2 - Fonts.newcode[11].getWidth(ping)), (float) p_238522_4_ + 3.5f, j);
