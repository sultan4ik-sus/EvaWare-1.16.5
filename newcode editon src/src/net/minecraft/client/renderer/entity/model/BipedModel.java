...
import newcode.fun.module.impl.render.CustomDance;
...
public class BipedModel<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead
{
    ...
    public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        this.bipedRightArm.rotateAngleX = Manager.FUNCTION_MANAGER.customDance.state && Manager.FUNCTION_MANAGER.customDance.modes.is("Дрочить") ? 0.0F : MathHelper.cos(limbSwing * 0.6662F + 3.1415927F) * 2.0F * limbSwingAmount * 0.5F / f;
        this.bipedLeftArm.rotateAngleX = Manager.FUNCTION_MANAGER.customDance.state && Manager.FUNCTION_MANAGER.customDance.modes.is("Дрочить") ? -32.0F : MathHelper.cos(limbSwing * 0.6662F) * 2.0F * limbSwingAmount * 0.5F / f;
        this.bipedRightArm.rotateAngleZ = 0.0F;
        this.bipedLeftArm.rotateAngleZ = Manager.FUNCTION_MANAGER.customDance.state && Manager.FUNCTION_MANAGER.customDance.modes.is("Дрочить") ? 32.2F : 0.0F;
        ...
        else
        {
            ...
            this.bipedLeftArm.rotationPointY = Manager.FUNCTION_MANAGER.customDance.state && Manager.FUNCTION_MANAGER.customDance.modes.is("Дрочить") ? 4.0F : 2.0F;
    ...
    private void func_241655_c_(T p_241655_1_)
    {
        switch (this.leftArmPose)
        {
            ...
            case BLOCK:
                if (!Manager.FUNCTION_MANAGER.customDance.state && !Manager.FUNCTION_MANAGER.customDance.modes.is("Дрочить")) {
