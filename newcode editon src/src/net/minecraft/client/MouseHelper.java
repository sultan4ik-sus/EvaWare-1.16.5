...
import newcode.fun.module.impl.movement.FreeCam;
...
public class MouseHelper {
    ...
    public void updatePlayerLook() {
        ...
        if (this.isMouseGrabbed() && this.minecraft.isGameFocused()) {
            ...
            FreeCam freeCam = (FreeCam) Manager.FUNCTION_MANAGER.get("Freecam");
            if (freeCam.state && freeCam.player != null) {
