...
public class Framebuffer {
    ...
    public void resizeRaw(int p_227586_1_, int p_227586_2_, boolean p_227586_3_) {
        if (!GLX.isUsingFBOs()) {
    ...
    private void framebufferRenderExtRaw(int width, int height, boolean p_227588_3_) {
        if (GLX.isUsingFBOs()) {
            ...
            bufferbuilder.pos(0.0, (double)f1, 0.0).tex(0.0F, 0.0F).color(255, 255, 255, 255).endVertex();
            bufferbuilder.pos((double)f, (double)f1, 0.0).tex(f2, 0.0F).color(255, 255, 255, 255).endVertex();
            bufferbuilder.pos((double)f, 0.0, 0.0).tex(f2, f3).color(255, 255, 255, 255).endVertex();
