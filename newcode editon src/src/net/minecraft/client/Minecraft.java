...
import newcode.fun.module.impl.player.ItemsCooldown;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    public void setDefaultMinecraftTitle() {
        this.mainWindow.setWindowTitle("NewCode 1.16.5 - Build: 1.04");
    }

    private String getWindowTitle() {
        StringBuilder stringbuilder = new StringBuilder("NewCode 1.16.5");
        ...
        if (!this.playerController.getIsHittingBlock()) {
            ...
            if (!this.player.isRowingBoat()) {
                ...
                for (Hand hand : Hand.values()) {
                    ...
                    ItemsCooldown cooldown = Manager.FUNCTION_MANAGER.gappleCooldownFunction;
                    ItemsCooldown.ItemEnum itemEnum = ItemsCooldown.ItemEnum.getItemEnum(itemstack.getItem());
