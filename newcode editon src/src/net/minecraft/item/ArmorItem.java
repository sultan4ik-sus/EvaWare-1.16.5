...
public class ArmorItem extends Item implements IArmorVanishable
{
    ...
    public ArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn)
    {
    ...
    public float getDamageReductionAmount() {
        // Возвращаем количество защиты, которое предоставляет данная броня
        // Например, если у вас есть броня с 3 единицами защиты
        return this.protectionAmount; // protectionAmount - это переменная, которая хранит количество защиты
    }
}
