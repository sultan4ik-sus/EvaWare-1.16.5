...
import newcode.fun.control.events.impl.player.EventLiquidSolid;
...
public class FlowingFluidBlock extends Block implements IBucketPickupHandler {
    ...
    protected FlowingFluidBlock(FlowingFluid fluidIn, Properties builder) {
        super(builder);
        this.fluid = fluidIn;
    ...
    public VoxelShape getCollisionShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
        ...
        return context.func_216378_a(LAVA_COLLISION_SHAPE, pos, true) && state.get(LEVEL) == 0
                && context.func_230426_a_(worldIn.getFluidState(pos.up()), this.fluid) ? LAVA_COLLISION_SHAPE : event.getCollision();
    }
