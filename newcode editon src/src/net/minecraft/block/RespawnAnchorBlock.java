...
import newcode.fun.control.events.impl.player.EventPlaceAnchorByPlayer;
...
public class RespawnAnchorBlock extends Block {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        EventPlaceAnchorByPlayer eventPlaceAnchorByPlayer = new EventPlaceAnchorByPlayer(this, pos);
        EventManager.call(eventPlaceAnchorByPlayer);
