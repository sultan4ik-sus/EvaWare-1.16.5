...
import static newcode.fun.module.impl.combat.AttackAura.bpstarget;
...
public class FireworkRocketEntity extends ProjectileEntity implements IRendersAsItem {
    ...
    float randomOffset = (random.nextFloat() - 0.5f) * 0.1f;
        ...
        if (this.isAttachedToEntity()) {
            ...
            if (this.boostedEntity != null) {
                if (this.boostedEntity.isElytraFlying()) {
                    if (!Manager.FUNCTION_MANAGER.antiTarget.state) {
                        if ((Manager.FUNCTION_MANAGER.auraFunction.state && Manager.FUNCTION_MANAGER.auraFunction.settings.get(1) && this.boostedEntity instanceof ClientPlayerEntity)) {
                            vector3d = this.getVectorForRotation(Manager.FUNCTION_MANAGER.auraFunction.rotate.y, Manager.FUNCTION_MANAGER.auraFunction.rotate.x);
                            Vector3d vector3d1 = this.boostedEntity.getMotion();
                            if (Manager.FUNCTION_MANAGER.elytraBooster.state) {
                                if (Manager.FUNCTION_MANAGER.auraFunction.target != null) {
                                    if (Manager.FUNCTION_MANAGER.elytraBooster.mode.is("Динамический")) {
                                        this.boostedEntity.setMotion(
                                                vector3d1.add(
                                                        (vector3d.x * 0.1 + (vector3d.x * Math.min(2.15, Math.max(1.60, bpstarget() / 22f) + Manager.FUNCTION_MANAGER.elytraBooster.speed4.getValue().floatValue() + (float) Math.random() * 0.023f) - vector3d1.x) * 0.5),
                                                        (vector3d.y * 0.1 + (vector3d.y * Math.min(1.95, Math.max(1.51, bpstarget() / 22f) + Manager.FUNCTION_MANAGER.elytraBooster.speed4.getValue().floatValue() + (float) Math.random() * 0.023f) - vector3d1.y) * 0.5),
                                                        (vector3d.z * 0.1 + (vector3d.z * Math.min(2.15, Math.max(1.60, bpstarget() / 22f) + Manager.FUNCTION_MANAGER.elytraBooster.speed4.getValue().floatValue() + (float) Math.random() * 0.023f) - vector3d1.z) * 0.5)
                                                )
                                        );
                                    } else {
                                        if (Manager.FUNCTION_MANAGER.elytraBooster.mode.is("Динамический")) {
                                            this.boostedEntity.setMotion(vector3d1.add(vector3d.x * 0.1 + (vector3d.x * 1.6 - vector3d1.x) * 0.5, vector3d.y * 0.1 + (vector3d.y * 1.56f + (float) Math.random() * 0.023f - vector3d1.y) * 0.5, vector3d.z * 0.1 + (vector3d.z * 1.6 - vector3d1.z) * 0.5));
                                        } else {
                                            this.boostedEntity.setMotion(vector3d1.add(vector3d.x * 0.1 + (vector3d.x * Manager.FUNCTION_MANAGER.elytraBooster.speed2.getValue().floatValue() + (float) Math.random() * 0.023f - vector3d1.x) * 0.5, vector3d.y * 0.1 + (vector3d.y * 1.59f - vector3d1.y) * 0.5, vector3d.z * 0.1 + (vector3d.z * Manager.FUNCTION_MANAGER.elytraBooster.speed2.getValue().floatValue() + (float) Math.random() * 0.023f - vector3d1.z) * 0.5));
                                        }
                                    }
                                } else {
                                    this.boostedEntity.setMotion(vector3d1.add(vector3d.x * 0.1 + (vector3d.x * Manager.FUNCTION_MANAGER.elytraBooster.speed.getValue().floatValue() + (float) Math.random() * 0.023f - vector3d1.x) * 0.5, vector3d.y * 0.1 + (vector3d.y * 1.55 - vector3d1.y) * 0.5, vector3d.z * 0.1 + (vector3d.z * Manager.FUNCTION_MANAGER.elytraBooster.speed.getValue().floatValue() + (float) Math.random() * 0.023f - vector3d1.z) * 0.5));
                                }
                            } else {
                                this.boostedEntity.setMotion(vector3d1.add(vector3d.x * 0.1 + (vector3d.x * 1.5 - vector3d1.x) * 0.5, vector3d.y * 0.1 + (vector3d.y * 1.5 - vector3d1.y) * 0.5, vector3d.z * 0.1 + (vector3d.z * 1.5 - vector3d1.z) * 0.5));
                            }
                        } else {

                            vector3d = this.boostedEntity.getLookVec();
                            ...
                            if (Manager.FUNCTION_MANAGER.elytraBooster.state) {
                                if (Manager.FUNCTION_MANAGER.auraFunction.target != null) {
                                    if (Manager.FUNCTION_MANAGER.elytraBooster.mode.is("Динамический")) {
                                        ...
                                        if (Manager.FUNCTION_MANAGER.elytraBooster.mode.is("Динамический")) {
                                            this.boostedEntity.setMotion(vector3d1.add(vector3d.x * 0.1 + (vector3d.x * 1.6 - vector3d1.x) * 0.5, vector3d.y * 0.1 + (vector3d.y * 1.56f - vector3d1.y) * 0.5, vector3d.z * 0.1 + (vector3d.z * 1.6 - vector3d1.z) * 0.5));
                                        } else {
                                            this.boostedEntity.setMotion(vector3d1.add(vector3d.x * 0.1 + (vector3d.x * Manager.FUNCTION_MANAGER.elytraBooster.speed2.getValue().floatValue() + (float) Math.random() * 0.023f - vector3d1.x) * 0.5, vector3d.y * 0.1 + (vector3d.y * 1.59f - vector3d1.y) * 0.5, vector3d.z * 0.1 + (vector3d.z * Manager.FUNCTION_MANAGER.elytraBooster.speed2.getValue().floatValue() + (float) Math.random() * 0.023f - vector3d1.z) * 0.5));
                                        }
                                    }
                        ...
                        if (Manager.FUNCTION_MANAGER.auraFunction.target != null) {
                            vector3d = this.getVectorForRotation(Manager.FUNCTION_MANAGER.auraFunction.rotate.y, Manager.FUNCTION_MANAGER.auraFunction.rotate.x);
                            Vector3d vector3d1 = this.boostedEntity.getMotion();
                            this.boostedEntity.setMotion(vector3d1.add(vector3d.x * 0.1 + (vector3d.x * Manager.FUNCTION_MANAGER.antiTarget.speed2.getValue().floatValue() - vector3d1.x) * 0.5, vector3d.y * 0.1 + (vector3d.y * Manager.FUNCTION_MANAGER.antiTarget.speed2.getValue().floatValue() - vector3d1.y) * 0.5, vector3d.z * 0.1 + (vector3d.z * Manager.FUNCTION_MANAGER.antiTarget.speed2.getValue().floatValue() - vector3d1.z) * 0.5));
                        } else {
                            vector3d = this.boostedEntity.getLookVec();
                            Vector3d vector3d1 = this.boostedEntity.getMotion();
                            this.boostedEntity.setMotion(vector3d1.add(vector3d.x * 0.1 + (vector3d.x * Manager.FUNCTION_MANAGER.antiTarget.speed2.getValue().floatValue() - vector3d1.x) * 0.5, vector3d.y * 0.1 + (vector3d.y * Manager.FUNCTION_MANAGER.antiTarget.speed2.getValue().floatValue() - vector3d1.y) * 0.5, vector3d.z * 0.1 + (vector3d.z * Manager.FUNCTION_MANAGER.antiTarget.speed2.getValue().floatValue() - vector3d1.z) * 0.5));
    ...
    private void dealExplosionDamage() {
        ...
        if (f > 0.0F) {
            ...
            Iterator var8 = this.world.getEntitiesWithinAABB(LivingEntity.class, this.getBoundingBox().grow(5.0)).iterator();
            ...
            while(true) {
                ...
                do {
                    ...
                    } while(livingentity == this.boostedEntity);
                } while(this.getDistanceSq(livingentity) > 25.0);
