    ...
    public LuaValue call(LuaValue modname, LuaValue env) {
        ...
        library.set("getItemSlot", new OneArgFunction() {
            ...
            public LuaValue call(LuaValue arg) {
                return LuaValue.valueOf(InventoryUtils.getItemSlot(Item.getItemById(arg.toint())));
            }
        });
        library.set("moveItem", new TwoArgFunction() {
            @Override
            public LuaValue call(LuaValue arg, LuaValue arg1) {
                InventoryUtils.moveItem(arg.toint(), arg1.toint(), false);
        ...
        library.set("dropItem", new OneArgFunction() {
            @Override
            public LuaValue call(LuaValue arg) {
                InventoryUtils.dropItem(arg.toint());
        ...
        library.set("pickupItem", new TwoArgFunction() {
            ...
            public LuaValue call(LuaValue arg, LuaValue arg2) {
                if (mc.player != null) {
                    InventoryUtils.pickupItem(arg.toint(), arg2.toint());
                }
                return LuaValue.valueOf(0F);
            }
        });
