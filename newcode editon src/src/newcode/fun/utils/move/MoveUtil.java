package newcode.fun.utils.move;
...
public class MoveUtil implements IMinecraft {
    ...
    public static void setSpeed(float speed) {
        AttackAura hitAura = Manager.FUNCTION_MANAGER.auraFunction;
        boolean check = (hitAura.isState() && hitAura.target != null && Manager.FUNCTION_MANAGER.auraFunction.settings.get(0));
