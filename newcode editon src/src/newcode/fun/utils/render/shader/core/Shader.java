package newcode.fun.utils.render.shader.core;
...
public class Shader {
    ...
    public Shader(String path) {
        init(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("newcode/shader/impl/" + path + ".frag")).getInputStream()));
    }
    ...
    private void init(String source) {
        ...
        ARBShaderObjects.glAttachObjectARB(program, createShader(FileUtil.readInputStream(mc.getResourceManager().getResource(new ResourceLocation("newcode/shader/vertex.vert")).getInputStream()), GL_VERTEX_SHADER));
    ...
    public void drawQuads(final float x,
        ...
        RenderUtils.Render2D.quadsBegin(x, y, width, height, GL_POLYGON);
    }
